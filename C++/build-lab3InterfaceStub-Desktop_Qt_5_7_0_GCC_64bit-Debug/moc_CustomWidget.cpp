...
#include "../lab3InterfaceStub/CustomWidget.h"
...
QT_MOC_LITERAL(1, 13, 21), // "changeToDefaultCursor"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 20), // "ShowCustomContexMenu"
QT_MOC_LITERAL(4, 57, 1) // "p"

    },
    "CustomWidget\0changeToDefaultCursor\0\0"
    "ShowCustomContexMenu\0p"
};
...
void CustomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeToDefaultCursor(); break;
        case 1: _t->ShowCustomContexMenu((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomWidget::changeToDefaultCursor)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomWidget::changeToDefaultCursor()
{
